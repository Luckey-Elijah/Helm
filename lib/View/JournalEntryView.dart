    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        [
          ...
          child: Text("Journal Entry",style: TextStyle(fontFamily: "Gotham-Light",color: Colors.white, fontSize: 20.0))
          ),
          Align(
            alignment: Alignment(0,-.3),
          child: TextField(controller: journalContorller,minLines: 2, maxLines: 10,decoration: InputDecoration(border: OutlineInputBorder()))),
        Align(
