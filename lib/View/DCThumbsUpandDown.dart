          ...
          children: <Widget>[
            ...
            Align(
                  alignment: Alignment(0,-0.8),
                    child: Text("How well are you feeling Today?.", style: TextStyle(color: Colors.white,),)
            ),

            Align(
              alignment: Alignment(-.2,-0.73),
              child: OnboardingClearButton(height: 50.0,width: 50.0,buttonText: "👍",)
            ),
            Align(
                alignment: Alignment(.2,-0.73),
                child: OnboardingClearButton(height: 50.0,width: 50.0,buttonText: "👎",)
            ...
            Align(
                ...
                child: Text("Anxious? ", style: TextStyle(color: Colors.white,),)
            ),
